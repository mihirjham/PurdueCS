...
/* in file pipwrite.c */
extern syscall pipwrite_nonblock(pipid32, char *, uint32);
extern syscall pipwrite_block(pipid32, char *, uint32);

/* in file pipread.c */
extern syscall pipread_nonblock(pipid32, char *, uint32);
extern syscall pipread_block(pipid32, char *, uint32);
