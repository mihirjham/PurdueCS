...
#define PR_SND		8	/* process is in sending state		*/
...
struct procent {		/* entry in the process table		*/
	...
	qid16	msgqueue;	/* message queue for sending processes	*/
	umsg32	sndmsg;		/* blocked message			*/
	char	sndflag;	/* flag to check if sndmsg holds 	*/
};
